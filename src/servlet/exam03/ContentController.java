...
public class ContentController extends HttpServlet {
	...
	//클라이언트에서 최초로 서블릿을 요청했을때 딱 한번 실행 (load-on-startup이 없을 경우)
	//load-on-startup 이 있을 경우 deployment시에 딱 한번 실행
	...
	//서블릿이 제거 될때(undeployment 될때)
	@Override
	public void destroy() {
		System.out.println(viewLocation + "exam03/ContentController.destroy() 실행");
